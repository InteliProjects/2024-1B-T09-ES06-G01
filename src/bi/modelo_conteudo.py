...
df = pd.read_csv('https://gist.githubusercontent.com/VictorGM01/96088788623016873c56b977a601e8e8/raw/08a6708458810a7e968485550099ba1234606d23/base-de-dados-final.csv')
...
def get_latest_model_path(models_dir='./bi/models'):
