...
# Comando para adicionar uma nova coluna chamada 'estado' com tipo VARCHAR
try:
    cursor.execute("ALTER TABLE Ceo ADD COLUMN estado VARCHAR(255)")
    connection.commit()
    print("Coluna 'estado' adicionada com sucesso à tabela Ceo.")
